...
const genList = (current, pageSize) => {
  ...
  for (let i = 0; i < pageSize; i += 1) {
    ...
    tableListDataSource.push({
      ...
      name: `Category ${index}`,
      slug: `category-${index}`,
      parentCategory: `Parent ${index % 10}`,
      tertiaryCategory: `Tertiary ${index % 6}`,
    });
  }
  ...
  switch (method) {
    ...
    case 'post':
      (() => {
        ...
        tableListDataSource.unshift(newCategory);
...
export { genList as genCategoryList };
